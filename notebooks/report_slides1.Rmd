...
- differ in ancestry and gender composition, case prevalence (SysBio,   FC,    GTP,     AURORA)
...
## Exploring classification models/algorithms | Setup
- Training/discovery cohort: SysBio (n=)
- Testing/replication cohort: FC (n=), GTP (n=), AURORA (n=)
...
## Exploring classification models/algorithms | Performance
...
where $\beta_{0}=, \beta_{1}=, \beta_{2}=,\beta_{3}= $


## More on model performance | PTSD status

## More on model performance | PTSD severity
